// databeat v0.1.0 4ab860952a4283efd839dc61936447b161d0581a
// --
// Code generated by webrpc-gen@v0.10.x-dev with golang@v0.10.0 generator. DO NOT EDIT.
//
// webrpc-gen -schema=databeat.ridl -target=golang@v0.10.0 -pkg=proto -client -out=./clients/databeat.gen.go
package proto
...
func WebRPCSchemaHash() string {
	return "4ab860952a4283efd839dc61936447b161d0581a"
}
...
type Databeat interface {
	...
	RawEvents(ctx context.Context, events []*Event) (bool, error)
}
...
func (c *databeatClient) RawEvents(ctx context.Context, events []*Event) (bool, error) {
	in := struct {
		Arg0 []*Event `json:"events"`
	}{events}
	out := struct {
